                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('student_profile.update',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('profile.user_name_in_arabic') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ trans('profile.user_name_in_english') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <hr>
                                <button type="submit" class="btn btn-success">{{ trans('profile.save') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
