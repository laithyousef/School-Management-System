...
<div>
    ...
    @endif
        ...
        @else
        <button class="btn btn-success  btn-lg pull-right" wire:click="return_to_menu" type="button">{{ trans('parent_trans.Back_To_Menu') }}</button><br><br><br><br>
                ...
                <div style="display: none" class="row setup-content" id="step-3">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12"><br>
                            ...
                            @if($update_Mode)
                                <button class="btn btn-success ml-2 nextBtn btn-lg pull-right" wire:click="submitForm_edit"
                                        type="button">{{trans('Parent_trans.Finish')}}
                                </button>
                            @else
                                <button class="btn btn-success ml-2 btn-lg pull-right" wire:click="submitForm"
