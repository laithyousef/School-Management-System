            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_zoom_classes.create')}}" class="btn btn-success mr-4" role="button" aria-pressed="true">{{ trans('online_classes_trans.Add_New_Lesson') }}</a>
                                <a class="btn btn-warning" href="{{route('indirect.teacher.create')}}" >{{ trans('online_classes_trans.Add_New_Lesson') }}</a>
                                 <br><br><br><br><br>
