                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Class_id">
                                                ...
                                                <option value="{{$class_room->id}}" {{ $class_room->id == $quizz->classroom_id ?'selected' : "" }}>{{ $class_room->name }} </option>
                                                @endforeach                                         
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="section_id">
                                                ...
                                                <option value="{{$section->id}}" {{ $section->id == $quizz->section_id ?'selected' : "" }} > {{$section->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
