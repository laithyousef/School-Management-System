...
use App\Repository\FeesInvoicesRepository_Interface;
...
class FeesInvoicesController extends Controller
{
    ...
    public function  __construct(FeesInvoicesRepository_Interface $Fees_Invoice)
    {
    ...
    {
        return $this->Fees_Invoice->update($request, $id);
    ...
    {
        return $this->Fees_Invoice->destroy($request, $id);
