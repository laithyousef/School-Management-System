...
@section('css')
    @toastr_css
@section('title')
  {{ trans('Attendence_trans.Student_Attendence_and_absence') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
...
@section('content')
    ...
    <h5 style="font-family: 'Cairo', sans-serif;color: red"> {{ trans('Attendence_trans.Today_Date') }} : {{ date('Y-m-d') }}</h5>
                    ...
                    <td>
                        ...
                        @if(isset($student->attendance()->where('attendence_date',date('Y-m-d'))->first()->student_id))
                            ...
                            <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                                ...
                                <span class="text-success">{{ trans('Attendence_trans.Presence') }}</span>
                            </label>
                            ...
                            <label class="ml-4 block text-gray-500 font-semibold">
                                ...
                                <span class="text-danger">{{ trans('Attendence_trans.absence') }}</span>
                            </label>
