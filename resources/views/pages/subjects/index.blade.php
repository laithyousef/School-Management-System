...
@section('css')
    @toastr_css
@section('title')
    {{ trans('main_translate.Subjects_List') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('subjects.create')}}" class="btn btn-success  nextBtn btn-lg pull-right" role="button"
                                   aria-pressed="true">{{ trans('Subjects_trans.Add_Subject_Name') }}</a><br><br>
                                   <br><br>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Subjects_trans.Delete_Subject_Name') }}</h5>
