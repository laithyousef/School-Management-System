            ...
            <br><br>
                ...
                <form action="{{ route('filter_classes') }}" method="POST">
                    ...
                    <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                        ...
                        <option value="" selected disabled>{{ trans('my_classes.Search_By_Grade') }}</option>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('class_rooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="exampleFormControlTextarea1">{{ trans('my_classes.Name_Grade') }}
                                                        :</label>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('class_rooms.destroy', 'test') }}"
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"
                                                            class="btn btn-danger">{{ trans('my_classes.OK') }}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('delete_all' ) }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ trans('my_classes.Close') }}</button>
                    <button type="submit" class="btn btn-danger">{{ trans('my_classes.OK') }}</button>
                </div>
            </form>
        </div>
    </div>
